...
def on_message(client, userdata, msg):
    try:
        ...
        print("⚠️ Fehler: Empfangener Payload ist kein gültiges JSON.")
    except Exception as e:
...
if __name__ == "__main__":
    ...
    if args.ip:
        ...
        try:
            ...
            print("-" * 40)
            print(f"🚀 GATEWAY BEREIT (Warte auf Nachrichten in '{MQTT_TOPIC}')")
            print("-" * 40)
